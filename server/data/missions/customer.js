module.exports = [
  {
    ...
    steps: [
      ...
      { text: 'Enter your name, your real email, and your real phone. Click Next.', expect: 'Step 3 (Extras) loads — the Package step is hosted-only and skipped for BYOB.' },
      { text: 'Check 1-2 add-ons and 1-2 syrups. Click Next.', expect: 'Total updates as you click. Step 4 (Review) loads with the full breakdown.' },
