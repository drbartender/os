...
module.exports = {
  ...
  // Staff / hiring / application templates re-exported from the sibling file for
  // backwards compat — consumers access them by property (emailTemplates.
  // applicationHired). staffHiringEmailTemplates.js is a leaf module (duplicates
  // the shared helpers, no require back into this file), so the spread is safe.
