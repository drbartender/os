...
- Bartenders manage their tip page from the staff portal Tip Card tab (`TipCardPage`) and download a bar sign from `DownloadTipSign`: 4x6 or 5x7 as JPG, PNG, or PDF for a photo counter, plus a two-sided hand-out card as a print-shop PDF. Every format comes off one html2canvas capture at 300 DPI
