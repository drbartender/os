...
- **Stripe payout tracking**: bank-level reconciliation tab in Financials (read-side mirror of Stripe payouts + balance-transaction lines, in-transit bucket, fee rollups, failed-payout email alert)
