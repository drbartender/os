...
│   │   │   ├── plan/           # PotionPlanningLab — public post-booking event questionnaire (single flow, created only after deposit; with steps/ and data/; steps/HostedGuestPrefsStep.js = compact hosted-package guest-preferences step; data/packageGaps.js = hosted-package gap helpers, packageGaps.test.js = Jest test)
...
│   │   │   └── website/        # Public website (HomePage, ServicesPage, MethodPage, AboutPage, FaqPage, QuotePage, ClassWizard, quoteWizard/ — split QuoteWizard)
│   │   ├── images/             # Brand assets
