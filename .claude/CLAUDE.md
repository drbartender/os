...
| `FIRST_REPLY_NIGHT_JITTER_START_HOUR` / `FIRST_REPLY_NIGHT_JITTER_END_HOUR` | Chicago dead-hours window `[start, end)` in which night-template leads get the 2-14 min reply jitter (defaults 2 and 8). Outside it night replies offer immediately — "night leads are fast until 2am" (2026-08-03). |
