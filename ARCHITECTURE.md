...
- `pricing_snapshot` (JSONB — full pricing breakdown at time of creation; also carries `gratuity {rate, tip_jar, staff_count, hours, staff_noun, total}`, `staff_noun`, and `display_labels`)
